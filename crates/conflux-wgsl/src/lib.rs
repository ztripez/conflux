...
//! plus an experimental exact proximity-query GPU scan helper; flow kernels lower
//! to inspectable amount/destination WGSL modules, but Conflux does not yet
//! provide runtime GPU dispatch for flows.
//!
